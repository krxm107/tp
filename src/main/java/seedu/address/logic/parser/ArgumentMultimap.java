 ...
 * Keys are unique,
 * but the list of argument values may contain duplicate argument values,
...
public class ArgumentMultimap {
    ...
    /**
     * Returns the preamble (text before the first valid prefix). Strips any leading/trailing spaces.
     */
