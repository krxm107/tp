...
public class ReactivateMembershipCommandParserTest {

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, ReactivateMembershipCommand.MESSAGE_USAGE);

    private ReactivateMembershipCommandParser parser = new ReactivateMembershipCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + MEMBER_DESC_AMY + CLUB_DESC_AMY + DURATION_DESC_AMY,
                new ReactivateMembershipCommand(targetPersonIndex, targetClubIndex, duration));
    }
